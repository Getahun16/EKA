...
export default function Sidebar({ collapsed, setCollapsed }: SidebarProps) {
  ...
  return (
    <aside className="h-full flex flex-col">
      <div className="flex justify-between items-center px-4 py-4 border-b border-sky-700">
      ...
      <nav className="px-2 py-6 space-y-2 flex-1 overflow-y-auto">
        ...
        <button
          ...
          className={`w-full flex items-center gap-2 px-2 py-2 rounded-md text-blue-300 hover:text-white hover:bg-sky-600 cursor-pointer transition ${
